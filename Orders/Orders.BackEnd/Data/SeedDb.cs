...
namespace Orders.BackEnd.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckProducsAsync();
            await CheckUserAsync("1010", "Quer", "Hidalgo", "quervin.hidalgo@grupopromerica.com", "322 311 4620", "San Juan City", "bob.jpg", UserType.Admin);
            await CheckUserAsync("1010", "Rafael", "Sequeria", "rafael.sequeria@grupopromerica.com", "542 856 8420", "Santa Cruz City", "fredy.jpg", UserType.User);
        }

        private async Task CheckProducsAsync()
        {
