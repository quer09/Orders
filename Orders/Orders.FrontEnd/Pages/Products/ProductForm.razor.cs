...
namespace Orders.FrontEnd.Pages.Products
{
    public partial class ProductForm
    {
        ...
        [Parameter] public EventCallback AddImagenAction { get; set; }
        ...
        private async Task OnDataAnnotationsValidatedAsyn()
        {
            ProductDTO.ProductCategotyIds = selected.Select(x => int.Parse(x.Key)).ToList();
